...
public class encryption {
	...
	{
		String input = "D≥ugi text. Ale nie, aø tak bardzo d≥ugi, jak mog≥o by siÍ wydawaÊ po iloúci znakÛw. NaprawdÍ, czasem moøna by by≥o nawet jakiú referacik tym wysa≥c... ale w sumie po co?!";  //Input String.
