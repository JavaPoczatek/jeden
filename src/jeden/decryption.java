...
public class decryption {
	...
	{
		String input = "1674753:37:$úYBO”M•üM?”BWa,f8am2Ò42YÒf tsFèüLlC50•{Êm8THmd!qÊ!-Ûcr=ZU6f6Tø•ø[fÍy≥Xz5#M0?yRÍø£4!cMRiz<y^TfM_EèUY@Û@ÊzXyjøPjø£jiNcA0&>(d+QèG5LzüzssÒm—'xl5—ig(£/:B  qÛèDqp2+Vx7∆/0P/#—VT";  //Input String.
		String deoutput = "";  //Output String.
		
		String tabinput = "QWERTYUIOPASDFGHJKLZXCVBNMqwertyuiopasdfghjklzxcvbnm ”•å£Øè∆—ÍÛπú≥øüÊÒ1234567890~`!@#$%^&*()_+-=[];',./{}:<>? ";  //List of characters.
